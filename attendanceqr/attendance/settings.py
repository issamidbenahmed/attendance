...
SECRET_KEY = 'django-insecure-pzj-q#a-g^=rg9i1-m1j*xv8k4xu^#n(9c%8!^glxq9y#d)k$_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.11.126','192.168.0.153','100.70.32.233', 'localhost','100.70.33.122', '127.0.0.1','192.168.1.42','192.168.1.40','192.168.1.34','192.168.0.108','192.168.11.153','*']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'attendance_db',   # Nom de la base de données
